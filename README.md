...
1. [Flutter - Android App Development](Android.md)
2. [Swift - iOS App Development](iOS.md)
3. [React.JS - Front-end Development.](Frontend.md)
4. [Node.JS and Python (Flask) - Backend Development.](Backend.md)
...
- [Write a Twitter Bot in Node.js](https://codeburst.io/build-a-simple-twitter-bot-with-node-js-in-just-38-lines-of-code-ed92db9eb078)
